export const zhTW = {
  ...
  chatglmConversationsUnsupportedTitle: "ChatGLM 會話暫不支援",
  chatglmConversationsUnsupportedDesc: "目前站點限制導致會話列表無法穩定取得",
  chatglmConversationsUnsupportedSync: "ChatGLM 會話暫不支援同步",
