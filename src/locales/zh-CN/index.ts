export const zhCN = {
  ...
  chatglmConversationsUnsupportedTitle: "ChatGLM 会话暂不支持",
  chatglmConversationsUnsupportedDesc: "当前站点限制导致会话列表无法稳定获取",
  chatglmConversationsUnsupportedSync: "ChatGLM 会话暂不支持同步",
